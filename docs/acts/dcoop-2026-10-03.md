...
Maine Craft Weekend)
**Status of this act:** Also music and AV lead: AV cover during this set is an open role (name waits). Also the fire performance, confirmed by the City - its time and place are yours to say (separate from this slot).
...
| After you | 5-minute changeover (proposed), then Lyons Den |
