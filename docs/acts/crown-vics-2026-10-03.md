# Deal memo - The Crown Vics - ZAOstock, Saturday 3 October 2026
...
Maine Craft Weekend)
**Status of this act:** Booked via Steve Peer, Black Moon (Zaal, 27 Aug). This is Steve's own list; the slot is ZAO's plan.

## Your slot

| Item | Detail |
|---|---|
| Position | 1 of 5, opening the day |
| Set window | **12:05 - 12:35** |
| Set length | 30 minutes (typed by Zaal) |
| Before you | the 5-minute welcome on the mic at 12:00 - you are the first music |
| After you | 10-minute changeover (proposed): the MC talks the event, then Acadia Rising |
...
- Rain or shine, and we do not cancel. The street is open to the sky, so bring
  layers and rain gear. There IS a Wallace Events tent and it has been up since
  28 August; this line no longer says "tent coverage, rain or shine" because
  that told an act the tent was the bad-weather answer, and it is not. Black
  Moon next door hosts its own evening - their room, not a second stage.
