...
spots. Steve's list was then three proposed acts, not four - and at 22:3x it
resolved: **The Crown Vics 12:05 and Steve's own set 20:00-22:00 are booked;
The Somes Sound, North Creek and DJ Aquavantes are out of the plan.** Grill round 2 (20:1x):
the 06:00 call is gone - crew is on site Friday night for soundcheck, vital crew
...
is a named contact plus a kit, not a dedicated person. All of the above was
confirmed by the orchestrator's 20:46 RETRO-LOG and the record in
`~/zao-vault/daily/2026-08-27.md`, which also carries what the relays had
dropped: a 5-minute intro at noon; **about 30 minutes per act** in the order
...
gaps, and the set lengths themselves fixed per act on our side. Everything you
...
## 1. One stage at a time, not two

**The day runs outdoors on the Franklin Street Parklet until 6pm, then the whole
thing walks next door into Black Moon and stays there.** Not two live stages
running at once.

This changed on 23 August and the public schedule at zaostock.com/program was
rebuilt for it. Your supply list reads as though both stages are live all day,
which is why some of the numbers below differ from what you were picturing.

Why we made the call:

- **One crowd.** The parklet is a street. If Black Moon is also live at 2pm,
  people have to choose, and 200 people split across two rooms feels like 100 in
  each. Kept together, the street looks full, which is the whole point of doing
  this outdoors on Franklin Street.
- **One PA crew at a time.** We do not have two sound crews. We barely have one
  that is fully spoken for. Running two live stages means two operators, two
  setups and two strikes, on a day whose crew is on site from Friday night.
- **The move is the moment.** At six the music stops outside and everyone walks
  into your bar together. That is a better handoff than a slow leak of people
  who were already indoors.
...
| Time | What | Notes |
|------|------|-------|
| 18:00 - 19:30 | Stilo DJ set | **Decided** (Zaal, 20:0x). Our DJ, confirmed on our side. Music is already on when the first person reaches the door |
| 19:30 - 20:00 | **UNSET** | Nothing booked (Zaal, 22:3x). PROPOSED: Fellenz's 30 minutes indoors, agreed 24 Aug and never placed. Otherwise Stilo runs on |
...
under our MC. **PROPOSED** means it is on a list and nobody has confirmed it as
booked - as of 27 August that is every act on your draft. Names appear only
where already public; the rest stay generic until 1 September.
...
| 12:05-12:35, opening | The Crown Vics | **Confirmed** - booked, Steve's act | Zaal, 22:3x: "he has his Crown Vics at start" |
| - | The Somes Sound, North Creek, DJ Aquavantes | **OUT** - not proposed, gone | Zaal, 22:3x |
| 20:00-22:00 | Steve's own set | **Confirmed** - booked | Zaal, 22:3x |
...
30 minutes indoors is the proposal. Close is your licence.

Two notes on that grid.

**Noon is the start, and it is fixed.** On 27 August we looked at opening at
11:00 to fit all five acts, and Zaal ruled it out the same day: music starts at
...
| 6 | Your own set, 20:00-22:00 | Steve | **BOOKED** - Zaal, 27 Aug 22:3x | North Creek, The Somes Sound and the DJ are out of the plan on both sides. The night is Stilo 6 to 7:30, a half hour we are filling, then you 8 to 10 |
...
| **Fire performance - Dcoop** | ZAO | **CONFIRMED by the City** (Roddy, via Zaal 27 August) and **the act is Dcoop**, in addition to his 13:20 music set (Zaal, 22:3x). Slot PROPOSED: on the walk, 17:55-18:15, Franklin Street between the two buildings, at sunset (8.5) |
...
| Screens inside showing the outdoor stream | ZAO | To build. This is the fix for your daytime footfall |
| Poster, promotion, lineup reveal 1 September | ZAO | On track |

---

## 5. Open items for you

Four things, in the order they block us.

**1. The PA handoff at 6pm.**
This is the biggest unanswered question on the whole day. When you say sound and
PA on each stage, we need to know whether that is one system that moves or two
systems that exist independently, who strikes the outdoor rig, who runs the
indoor one, and whether it is the same operator doing both. On a day that runs one
stage at a time, a single system that moves is cheaper and simpler, but only if
somebody is being paid to move it while the crowd walks. If it is two systems,
that is fine too, we just need to know now.
...
maybe an accessible unit. Our read is four total: your one, two more standard,
and one ADA accessible. For a free public street event that is the number that
does not embarrass us. What we need from you is who books it, since you know the
local vendor, and whether Black Moon is covering any beyond the first. We are
ready to pay for the rest.

**3. Wristbands or lanyards for basement access.**
Agreed, and your rule is right, the basement is a dressing room and not a
hangout. Proposal: we buy them and bring them, you tell us who gets one. Our
...
**4. Your acts - answered on 27 August, one thing left.**
Zaal's words: "just the set I said going from 8-10, and he has his Crown Vics
at start." So The Crown Vics open the day at 12:05 and your set closes it from
8 to 10, both booked; The Somes Sound, North Creek and the DJ are out of the
plan, and we will not ask about them again. What is left from you on the
evening:

- The indoor PA for Stilo's set and for yours - the house system, or something
  brought in? This used to be a Somes Sound question and it is now simply
  yours.
- Close: whatever your licence says. We print nothing after 10 until you tell
  us the hour.

The half hour between Stilo and you, 7:30 to 8, is ours to fill and we will
tell you what goes there.

---

## 6. Dates between now and then
...
## 7. The one measurement that cannot be taken afterwards

The stated point of this day is showing what an event like this does for local
businesses. That means an average Saturday compared against 3 October, and after
3 October nobody can go back and find out what a normal Saturday looked like.

Steve, the ask we talked about: roughly what does a normal Saturday take at
Black Moon, and what did 3 October take. Ranges are completely fine, and we
publish it combined across businesses rather than per business unless you want
the credit. Two other downtown businesses will get the same question. This is
the only thing on the whole board whose window shuts permanently on 3 October.
...
| Decision | Who | State |
|----------|-----|-------|
| Overrun rule: an act that runs over loses the time from its own changeover, and the next act still starts on the grid | Stage manager, enforced from the side of stage | **YES** - Zaal, 27 August. Goes into the artist contracts and is said out loud at the stage manager's walk |
...
### 8.3 Before noon - the morning block, with names where they exist

The review said the run of show started as if the site assembled itself. Zaal's
answer (27 Aug, grill round 2): **the site assembles on Friday.** Crew is on
site the night before for soundcheck, the 06:00 Saturday call is gone, vital
crew is on site at 08:00 and everyone by 10:00.
...
| 17:55 - 18:00 | Result announced. The MC walks the crowd: "next door, now, the music is already on". Music plays out on the outdoor PA. **Dcoop's fire performance starts on the street** | Hurricane on the mic; **Stilo DJs the transition out of WaveWarZ** - decided at the 24 Aug standup, he travels for it. Fire: **Dcoop** (Zaal, 22:3x) | Stilo confirmed on our side; the fire performance is confirmed by the City (Roddy, 27 Aug) and its placement here is **PROPOSED** - it is the spectacle the walk was missing, and sunset is 18:12 |
...
| 18:00 - 18:15 | The fire performance on the walk between the two buildings; the crowd follows it to Black Moon's door. Somebody on the street pointing as well, so nobody drifts to their car | Fire: **Dcoop**. Pointer: **UNSET** - a crew name, not a performer | Placement PROPOSED. Fire on a public street at the move: the fire permit is the city lane's and Roddy has said yes |
| 19:30 - 20:00 | UNSET - Fellenz's indoor 30 PROPOSED; otherwise Stilo runs on | Zaal | Not decided |
| 20:00 | Steve's own set, to 22:00 | Steve - BOOKED (Zaal, 22:3x) | Decided |
...
| 19:30-20:00 stays empty | Stilo's DJ set runs on to 20:00 and hands to Steve | Real fallback - Stilo is confirmed on our side |
...
| Stilo | Before 16:00 or after 19:30 (20:00 if he holds the hole) - he battles at 16:00 and DJs 17:55-19:30 | Same | |
| Dcoop, twice | After his 13:50 finish, and before the 17:55 fire slot | Same | He plays and he spins fire |
...
| Time | Moment | Note |
|------|--------|------|
| 11:45 | The empty stage and the street, before doors | The before shot for the local-lift story |
| 12:00 | Doors, the first crowd on Franklin Street | |
...
| Music off indoors | Steve's set ends 22:00; anything after is the licence | **UNSET** |
...
question to Roddy about how early amplified sound may start is withdrawn; the
...
### Draft 1 - to Steve Peer, Black Moon - SUPERSEDED 27 August

This draft assumed North Creek was booked and asked only for the downbeat. It is
kept for the record. The live version, which asks the booked-which question
first, is `docs/drafts/steve-followup-2026-08-27.md`.
...
### Draft 2 - to Roddy, City of Ellsworth - the 11:00 paragraphs WITHDRAWN 27 August

Music starts at noon, so the first three paragraphs below are dead. The two
open items at the end still stand. The live message is the city lane's
`docs/drafts/roddy-2026-08-27.md`; this is kept for the record.
...
| 19:30-20:00 | Zaal | The printed evening between the DJ set and Steve | **UNSET** - Fellenz's indoor 30 PROPOSED |
| Does the permit cap an 11:00 start | - | Nothing any more | **WITHDRAWN** - music starts at noon, Zaal 27 August. Never sent |
| The fire performance | Roddy (yes), Dcoop (the act) | Its slot | **CONFIRMED**, act Dcoop (22:3x); slot on the walk PROPOSED |
...
Until the top answers land, the public schedule prints noon to six outdoors,
sets from 12:05 with no count, a DJ set 18:00-19:30 inside, and the closer as
in booking with no name. Which act moves, if one does, changes nothing public until it is decided:
...
- Single-venue correction, 23 August 2026, and the rebuilt public schedule at
  `src/app/program/page.tsx` (PR #47)
- ZAOstock run of show v2, ZAOOS research doc 2391
- ZAOstock standup, 24 August 2026
