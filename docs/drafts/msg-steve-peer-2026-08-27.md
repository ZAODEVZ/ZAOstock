...
- **Attach or link:** the production plan (docs/plans/production-plan-2026-10-03.md, sections 1-8 - not section 9, which is our working section)
...
and what we need from you, so we are working off one page.

Really appreciate you. October 3 is going to be good.
