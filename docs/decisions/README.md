...
| [0005](0005-confirmed-means-confirmed-in-writing.md) | Confirmed means confirmed in writing, and nothing softer | 2026-09-02, Iman | active |
| [0006](0006-artist-phone-numbers-stay-in-the-form-sheet.md) | Artist phone numbers live only in the form's responses sheet, never the database or any git repo | 2026-09-10, vault lane on zaostock's measurement | active |
