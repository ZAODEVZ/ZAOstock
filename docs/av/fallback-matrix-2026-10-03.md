...
| 3 | Streaming computer (Ellsworth desktop) | Won't boot, crashes under load, cannot be moved to the parklet | "Desktop plus VPS or Pi fallback" discussed on the 18 Aug call; a laptop is not mentioned anywhere | Doc 2316 | Aziz | Discussed, never built. UNSET what the VPS or Pi would do |
