...
- [ ] **Get the insurance certificate naming the City as additional insured.** The parklet permit is verbally agreed and its written confirmation is UNSET; the certificate is what the City is waiting on. **This is the only open item that can CANCEL the event rather than degrade it.**
