...
_Fill in: one sentence summary._
...
- **Cadence**: _fill in_
- **Vocabulary**: _fill in_
- **Punctuation**: _fill in_
- **Example post in your voice**: _paste recent X or Farcaster post_
...
- Never commit money on your behalf
- Never speak for ENTERACT clients
- _fill in others_
...
- Co-builds with Zaal on ZAOstock / ZAO Festivals strategy
- _fill in_

## External presence

- _Farcaster handle, X, etc._
