...
export const ARTIST_DATES: ReadonlyArray<{ when: string; what: string }> = [
  ...
  { when: `${SOUNDCHECK.day}, ${SOUNDCHECK.window}`, what: 'Soundcheck on the parklet stage, staggered through the block - not everyone needs to be there right at 9:30. Let us know what time you will be there. Crew is in from 8.' },
