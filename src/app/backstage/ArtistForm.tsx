  ...
  return (
    <div className="space-y-4" id="form">
      ...
      <p className="text-sm text-ink-secondary m-0">
        {ARTIST_FORM.askLabel}. It is your agreement to play, with the terms at the top, and your own post goes up once your details are in. No login and no code needed.
