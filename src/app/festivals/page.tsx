...
const SERIES: Chapter[] = [
  { name: 'ZAO-PALOOZA', place: 'New York City', year: 'April 2024', note: 'Twelve artists, the community’s first IRL meetup. Volunteer-organised in six weeks. Broke even.', href: '#recap', status: 'past' },
