...
// the 1 September reveal, and the fallback lineup must answer to the slug the
...
describe('lineup reveal gate', () => {
  it('is closed before 1 September 2026 and open from that day', () => {
    expect(lineupIsPublic(new Date('2026-08-31T23:59:59Z'))).toBe(false);
    expect(lineupIsPublic(new Date('2026-09-01T00:00:00Z'))).toBe(true);
